...
VF=3.1V の IF=0.08A を狙うと、抵抗は 0.2V で 0.08A だから 2.5Ωということになる。発熱は
0.016W。4.7Ωが手元にあったから、それで行こう。とか思ったが、そもそも、3.3V 供給するパーツ
だけ作って v2.0 や v2.1 の電池と入れ替えれば OK で新たに作る必要はなさそう。

なんかこれまで回路図を書いてなかったみたいだから、回路図を書こう。

と思ったんだが、これ安定して流せる電流は 10mA のオーダーで、今回みたいに 100mA のオーダー
を流したいのには不向き。
