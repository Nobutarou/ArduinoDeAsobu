...
さて 2.49V に対する 12bit ADC の分解能は 0.6079V/カウント。となると 2.5mV は 4カウント。た
しか ADC の誤差って 4カウントくらいでふらつくはずだから、これはまず計測不可能ということに
なる。これをちょろまかす必要がある。

また、過去作から、最序盤で最高値を叩き出して、すぐに計測が終ってしまうようなこともあるのも
分かっている。ただし、過去作は、PWM で電圧調整していたため、測定時に PWN を止めていた。つ
まり充電中の電圧を測定できていない。なので、これは杞憂かもしれない。
ただ、そのあたりの精度の低さ、ふらつきをちょろまかしておきたい。

そこで 

1. 1.3125sec (=84sec/64) ごとに ADC を掛けて、64 回分の移動平均を取る
2. 最大値の確認と、更新
3. 64回 (84秒) 連続で最大値を下回れば、終了
4. 2時間でも終了

こんな感じだろう。つまり 64回も比較をすれば、電圧が上昇傾向にあるなら、誤差があるとは言え、
一度くらいは最大値に届くだろう。
