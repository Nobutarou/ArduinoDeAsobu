...
[RL78/GL24, SOP 20のボード](../MiconBoards/RL78_G24/R7F101G6E2DSP/)
でやってみよう。

RESET (#5), VSS,VDD (#9,10) と P14,15 (#11,12) は使用が確定しているので #5~10, #11~16 でや
れば良い。UART は P00 (#2) は必要なときだけ挿せばいい。

[回路図](./v3.0/DiodeTesterRL78G23_v4.0/DiodeTesterRL78G23_v4.0.pdf)

[設計図](./v3.0/DiodeTester3.0.pdf)
...
![完成作](./v3.0/DiodeTester3.0.jpg)
3.6V のツェナーを測ったところ。
指数なしの少数点表記のほうが、この場合は Vf, Vr の関係が一目で分かりやすい。
気が向いたら、挑戦してみるかも。
