...
USB 2.0 ハブ用の電源など、ここから取れたら便利だと思うのでアダプタを考える。ヒューズと手持
ち最大の 220uF は付ける。マザボの回路を使ってないので、別にでかいコンデンサが付いてても問
題なし。あとスイッチも付けよう。

[回路図](./5VSTB_Adaptor/v1.0/5VSTB_Adaptor_1.0/5VSTB_Adaptor_1.0_Schematics.pdf)

[設計図](./5VSTB_Adaptor/v1.0/5VSTB_Adaptor_1.0.pdf)
