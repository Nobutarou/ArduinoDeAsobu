...
Switch に必要な配線が 5本となるので、XH コネクタは 5P となり設計図は作り直し。もちろん回路
図も作り直し。
...
プルアップ抵抗を考える。S の漏れ電流 I_IN は±1uA だそうだ。0.1V くらいの変動は問題ないと
思うので 1uA/0.1V=100kΩくらいは大丈夫そうだ。前回は 10kΩと根拠もなくそうしたが、今回はブ
レッドボードで 100kΩを試してみよう。
