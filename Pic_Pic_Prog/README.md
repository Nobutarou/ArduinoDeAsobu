...
- USB-B の隣のラインを削ったが、穴空けしずらかったから、両隣を空ける
- v1.0 は後からファームウェアを更新できるようにソケットを用意してあったが、多分使わないか
  ら削る
- LED も光ろうが光らなかろうが、自分にできることは無いから省く
- その他の IO も使わないから省く
- 電源ラインの強化

ついでに知ったこと:

- a-p-prog では #12, #13 を使って書き込みをしていたが、#9, #10 でもできる
  - USB と配線を被らせないようにするには #9, #10 を使う方が良いかも
  - まあこれはターゲット機の話しで、本機には無関係
